...
- Read the deployment report from `/Users/robbwinkle/git/outline-workflows/reports/deploy.json`
...
- Read integration test configuration from `/Users/robbwinkle/git/outline-workflows/tests/integration/` directory
...
```bash
cd /Users/robbwinkle/git/outline-workflows && bun test tests/integration/
```
...
- **Path Traversal Prevention**: Validate all file paths stay within `/Users/robbwinkle/git/outline-workflows/` directory
...
Create a comprehensive report at `/Users/robbwinkle/git/outline-workflows/reports/integration.json` with the following structure:
```json
{
...
- **Use absolute paths**: All file operations must use absolute paths starting from `/Users/robbwinkle/git/outline-workflows/`
...
2. **File Locations**
   - Absolute path to integration report: `/Users/robbwinkle/git/outline-workflows/reports/integration.json`
...
Integration Report: /Users/robbwinkle/git/outline-workflows/reports/integration.json
